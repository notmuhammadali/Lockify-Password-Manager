...
class Popup:
    ...
    def __init__(self, master):
        ...
        dark_title_bar(self.popup)
        self.popup.title("Password Generator")
        self.popup.config(padx=30, pady=30, background=BG_COLOR)
        ...
        self.label_title = tk.Label(self.popup,
        ...
        self.label_password = tk.Label(self.popup,
                                       text="Password",
                                       width=20, height=3,
                                       relief="sunken", bg="#cccccc",
                                       fg="blue", font=PWD_FONT, wraplength=200)

        self.scale_length = tk.Scale(self.popup,
                                     label="Password Length",
                                     from_=6, to=48, length=200,
                                     font=NORMAL_FONT,
                                     bg=BG_COLOR,
                                     highlightbackground=BG_COLOR,
                                     orient=tk.HORIZONTAL, command=self.scale)

        self.checkbox_upper = tk.Checkbutton(self.popup,
                                             text="Use A-Z",
                                             font=NORMAL_FONT,
                                             background=BG_COLOR,
                                             variable=self.check_upper,
                                             command=self.do_it)

        self.checkbox_lower = tk.Checkbutton(self.popup,
                                             text="Use a-z",
                                             font=NORMAL_FONT,
                                             bg=BG_COLOR,
                                             variable=self.check_lower,
                                             command=self.do_it)

        self.checkbox_number = tk.Checkbutton(self.popup,
                                              text="Use 0-9",
                                              font=NORMAL_FONT,
                                              bg=BG_COLOR,
                                              variable=self.check_number,
                                              command=self.do_it)

        self.checkbox_symbol = tk.Checkbutton(self.popup,
                                              text="Use !@#$%^&*",
                                              font=NORMAL_FONT,
                                              bg=BG_COLOR,
                                              variable=self.check_symbol, command=self.do_it)

        self.spinbox_number = tk.Spinbox(self.popup,
                                         from_=1, to=9, width=3,
                                         font=LARGE_FONT,
                                         bg=BG_COLOR,
                                         command=self.do_it)

        self.spinbox_symbol = tk.Spinbox(self.popup,
                                         from_=1, to=9, width=3,
                                         font=LARGE_FONT,
                                         bg=BG_COLOR,
                                         command=self.do_it)

        self.label_number = tk.Label(self.popup,
                                     text="How many numbers",
                                     font=NORMAL_FONT,
                                     bg=BG_COLOR,
                                     pady=5)

        self.label_symbol = tk.Label(self.popup,
                                     text="How many symbols",
                                     font=NORMAL_FONT,
                                     bg=BG_COLOR,
                                     pady=5)

        self.button_close = tk.Button(self.popup,
                                      text="Close",
                                      font=NORMAL_FONT,
                                      bg="#00ACC1",
                                      command=self.close)
